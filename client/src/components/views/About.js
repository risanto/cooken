...
const About = () => {
    return (
        <>
            <Nav showLogo={true} />
            <main
                className="container flex flex-col justify-center pb-8 mb-auto align-center lg:px-32"
            >
                ...
                <div className="mt-4 w-80 sm-500:w-2/3 lg:w-1/2 place-self-center">
                    ...
                    <div className="mt-10 text-sm text-right">
                        ...
                        <ul>
                            <li><a href='https://pngtree.com/so/victory'>- <u>https://pngtree.com/so/victory</u></a></li>
                            <li><a href='https://pngtree.com/so/fridge-clipart'>- <u>https://pngtree.com/so/fridge-clipart</u></a></li>
                            <li><a href='https://pngtree.com/so/hunger'>- <u>https://pngtree.com/so/hunger</u></a></li>
                        </ul>
                    </div>
                </div>
            </main>
