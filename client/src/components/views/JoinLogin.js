...
const JoinLogin = (props) => {
    ...
    return (
        <main
            ...
            className="mt-12 overflow-scroll h-screen bg-no-repeat bg-contain below-sm-500:bg-none bg-30% sm-500:bg-chef-celebration sm-500:bg-right sm-500:bg-indigo-10 relative mb-auto"
        >
            <Nav showLogo={true} />

            <section className="flex flex-col w-full pb-10 mb-8 bg-white sm-500:my-8 sm-500:rounded-lg sm-500:shadow-md sm-500:w-2/3 lg:w-1/3 sm-500:mx-auto">
