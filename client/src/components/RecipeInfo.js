...
const RecipeInfo = ({ readyInMinutes, servings, vegetarian, vegan, glutenFree, dairyFree }) => {
    return (
        <section className="flex flex-wrap justify-center p-3 text-sm flexContainer w-13/16 align-center">
            ...
            <span className="flex justify-center align-center">
                <img src="../serving.png" className="inline-block w-4 mb-2 mr-2" />
                <p className="inline-block mb-2 mr-3">{servings} servings</p>
            </span>

            {glutenFree && (
                <span className="flex justify-center align-center">
                    <img src="../gluten-free.png" className="inline-block w-5 h-5 mb-2 mr-2" />
            ...
            {glutenFree && (
                <span className="flex justify-center align-center">
                    <img src="../dairy-free.png" className="inline-block w-5 h-5 mb-2 mr-2" />
