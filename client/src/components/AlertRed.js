...
const AlertRed = ({ message, dismissAlert, setDismissAlert }) => {

    if (dismissAlert) return null
    else return (
        <div class="flex justify-center items-center font-medium p-2 bg-white rounded text-red-700 bg-red-100 border border-red-300 ">
                        <div slot="avatar">
                        ...
                        <div onClick={() => setDismissAlert(true)} id="x-btn" class="flex flex-auto flex-row-reverse">
                            <div>
